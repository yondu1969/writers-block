            ...
            <div className="col-lg-10 mx-auto">
              <div className="recipe-detail-content">
                <p className="fs-18">
                  ...
                  ratione optio nulla illum, eius do lor maiores nulla illum,
                  sitiamet, consectetur a dipis icing eit amet, conse ulla
                  illum, eius do lor maiores nulla illum, Lorem ipsum dolor sit
                  a et, coinsectetur a dip onsectetur a dipis icing elit.
                  Eaisicing elit. Ea ratione o ptio nulla illum, eius lla illum,
                  Loremo lor sit amet, consectetur a dipis icing eit amet, conse
                  ulla illum, eius do lor maiores nulla illum, Lorem ipsum dolor
                  s it am et, consecetur a dip onsectetur a dipis icing elit.
                  Eaisicing nulla illum, eius lla illum, Lorem ipsum dolor sit.
                </p>

                <p className="fs-18">
                  Ea ratione o ptio nulla illum, eius lla illum, Loremo lor sit
                  amet, consectetur a dipis icing eit amet, conse ulla illum, us
                  do lor maiores nulla illum, Lorem ipsum dolor s it am et,
                  consect etur a dip onsectetur a dipis icing elit. Eaisicing
                  nulla illum, eius lla illum, Lorem ipsum dolor sit.
                </p>
                ...
                <div className="meal-cooking">
                  <div className="row">
                    <div className="col-md-5">
                      ...
                      <ul className="p-0 m-0 list-unstyled meal-indi">
                        <li>
                          <i className="fas fa-check"></i>1/3 cup of sugar
                        </li>
                        <li>
                          <i className="fas fa-check"></i>2 eggs
                        </li>
                        <li>
                          <i className="fas fa-check"></i>1 tea spoon of soda
                        </li>
                        <li>
                          <i className="fas fa-check"></i>100 grams of butter
                        </li>
                        <li>
                          <i className="fas fa-check"></i>1/4 cup of semolina
                        </li>
                        <li>
                          <i className="fas fa-check"></i>100 grams of butter
                        </li>
                        <li>
                          <i className="fas fa-check"></i>250 ml of milk
                        </li>
                        <li>
                          <i className="fas fa-check"></i>1 lemon, juice only
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="meal-inst pt-80">
                    ...
                    <ul className="p-0 m-0 list-unstyled">
                      <li>
                        <i className="fas fa-circle"></i>Melt butter and honey
                        in small pot, remove from heat and cool down.
                      </li>
                      <li>
                        <i className="fas fa-circle"></i>Whip eggs with sugar
                        over warm bath.
                      </li>
                      <li>
                        <i className="fas fa-circle"></i>Mix butter & honey
                        mixture with flour, baking soda, eggs and sugar, knead
                        the dough.
                      </li>
                      <li>
                        <i className="fas fa-circle"></i>Bake in preheated oven
                        in 180 C degrees about 5 minutes, till it turns golden
                        brown.
                      </li>
                      <li>
                        <i className="fas fa-circle"></i>Mix butter with sugar,
                        then add semolina bit by bit, add lemon juice and a few
                        drops of almond oil.
                      </li>
                      <li>
                        <i className="fas fa-circle"></i>To assemble the cake
                        smear firs layer with blackcurrant jelly, then with
                        cream and cover with second layer of cake, repeat the
                        procedure.
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-md-7">
                      <div className="recipe-chef">
                        ...
                        <h4 className="fs-26 text-uppercase">James Smith</h4>
                        <p>
                          Lorem ipsum dolor sit amet, consectetur a dipisicing
                          ratione op nulla illum, eius do lor maiores nullalu il
                          met, consectetur a dipilorimesa ulmes uil oil cing eit
                          amet
                        </p>
                ...
                <div className="woocommerce-Reviews mt-5">
                  ...
                  <div className="comment-text">
                    ...
                    <p>
                      Etiam semper nibh orci, ac tincidunt mi consectetur a. In
                      quis tortor ex. Morbi cursus sed neque quis dictum. Duis
                      bibendum ullamcorper pharetra, Viva mus quis turpis et
                      enim volutpat convallls.
                    </p>
                  </div>
                </div>
                <div className="leave-review bg-gray">
                  <div className="review-title d-sm-flex justify-content-between mb-4 align-items-center">
                    <h4 className="mb-0">
                      <span className="flaticon-login mr-2"></span>Login to
                      write a review
                    </h4>
